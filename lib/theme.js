...
const theme = createTheme({
  ...
  overrides: {
    MuiButton: {
      ...
      containedPrimary: {
        color: 'white',
        boxShadow: `0px 3px 1px -2px rgb(${primaryRgb} / 30%), 0px 2px 2px 0px rgb(${primaryRgb} / 24%), 0px 1px 5px 0px rgb(${primaryRgb} / 22%)`,
        '&:hover': {
          boxShadow: `0px 2px 4px -1px rgb(${primaryRgb} / 40%), 0px 4px 5px 0px rgb(${primaryRgb} / 34%), 0px 1px 10px 0px rgb(${primaryRgb} / 32%)`,
        },
      },
    },
    MuiTextField: {
